            ...
            <div class="container">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('sessions.update', ['role' => auth()->user()->role, 'session' => $session->id]) }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    value="{{ old('first_semester_start_date', optional($session->first_semester_start_date)->format('Y-m-d')) }}"
                                    required
                                >
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    value="{{ old('second_semester_start_date', optional($session->second_semester_start_date)->format('Y-m-d')) }}"
                                    required
                                >
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select id="current_semester" name="current_semester" class="form-select">
                                    <option value="" {{ old('current_semester', $session->current_semester) == '' ? 'selected' : '' }}>-- Select Current Semester --</option>
                                    <option value="first" {{ old('current_semester', $session->current_semester) == 'first' ? 'selected' : '' }}>First Semester</option>
                                    <option value="second" {{ old('current_semester', $session->current_semester) == 'second' ? 'selected' : '' }}>Second Semester</option>
                                </select>
